...
import { WORKSPACES, PERSONAS } from './state.js?v=20260823i';
import { PUBLIC_CANOPY_LITE_MODEL } from './browserLocal.js?v=20260823i';
import { cleanAssistantText, escapeHtml, renderMarkdown } from './markdown.js?v=20260823i';
